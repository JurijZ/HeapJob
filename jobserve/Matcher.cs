...
namespace jobserve
{
    public static class Matcher    {
        ...
        {
            var jobserve_collection = db.GetCollection<Job>("jobserve");
            ...
            if (lastAppliedJob != null)
            {
                ...
                var preveousjob = jobserve_collection.Find(applicationURL_filter).FirstOrDefault();
                ...
                if (preveousjob == null)
                {
                    ...
                    preveousjob = jobserve_collection.Find(applicationURL_filter2).FirstOrDefault();
            ...
            var latestjobs = jobserve_collection.Find(latestjobs_filter);

            // Regex filter
            //var search_filter = Builders<Job>.Filter.Regex("Description", new BsonRegularExpression("C#"));
            //var latestjobs = jobserve_collection.Find(search_filter);
